...
const UserSidebar = () => {
    ...
    return (
        <div className="profile-card grid grid-rows-12 grid-cols-12 rounded-lg sticky top-0 bg-gray-800">
            ...
            <button className="profile-button row-start-4 col-start-3 col-span-8 text-white text-lg rounded-lg justify-self-center bg-gray-700 p-3 m-3">My profile</button>
