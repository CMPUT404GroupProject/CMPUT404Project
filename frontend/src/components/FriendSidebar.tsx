...
const FriendSidebar = () => {
    return (
        <div className="friend-sidebar-card rounded-lg grid grid-rows-12 grid-cols-12 sticky top-0 bg-gray-800 p-5">
            <button className="create-post-button row-start-1 col-start-3 col-span-8 text-white text-lg rounded-lg self-start justify-self-center  bg-blue-600 p-3 m-3">Create post</button>
